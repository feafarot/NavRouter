module routing
{
    export class HashService
    {
        ...
        start()
        {
            ...
            {   // Event supported (Google Chrome 5+, Safari 5+, Opera 10.60+, Firefox 3.6+ and Internet Explorer 8+)
        ...
        private hashChanged(newHash: string): void
        {
            ...
            if (this.on_changing)
            {
                ...
                this.on_changing(
                    ...
                    {
                        if (currentCount != this.callCount)
                        { // Cancelled by url changing on default!
                            return;
                        }
        ...
        private onHashChangedEventHandler()
        {
            ...
            { // This should handle (magic!)floating bug in IE9.
                return;
            }
