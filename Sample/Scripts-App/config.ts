...
var routes = [
    new routing.routes.NavigationRoute("pages/p1", "page1.html",
        { cacheView: true, isDefault: true, vmFactory: (callback) => { callback(new viewModels.Page1VM()); }, vmCanLeave: "canLeave", title: "Page #1" }),
    new routing.routes.NavigationRoute("pages/p2/:name/:value", "page2.html?value={value}",
        { cacheView: false, vmFactory: (callback) => { callback(new viewModels.Page2VM()); }, onNavigateTo: "onNav", title: "Page #2" }),
    new routing.routes.NavigationRoute("pages/p3", "page3.html",
        { cacheView: false, vmFactory: (callback) => { callback(new viewModels.Page3VM()); }, onNavigateTo: "onNav", title: "Page #3" }),
];
